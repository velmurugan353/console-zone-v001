            ...
            <div className="relative overflow-hidden bg-[#080112] border border-white/10 group mx-auto" style={{ borderRadius: 'var(--layout-border-radius, 3.5rem)', maxWidth: 'var(--layout-max-width, 1280px)' }}>
                ...
                <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2">
                    ...
                    <div className="p-8 md:p-16 space-y-8">
                        ...
                        <div className="pt-8">
                            <Link to="/membership">
                                <button className="px-10 py-5 bg-gradient-to-r from-amber-400 to-amber-600 text-black font-black uppercase tracking-widest rounded-2xl flex items-center gap-3 hover:scale-105 transition-all shadow-[0_10px_50px_rgba(251,191,36,0.2)]">
                                    INITIALIZE SUBSCRIPTION <ChevronRight size={20} />
                                </button>
                            </Link>
                        </div>
                    </div>
