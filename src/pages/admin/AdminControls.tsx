...
const MatrixToggle = ({ label, description, icon: Icon, enabled, onToggle }: any) => (
  <div className="bg-[#0a0a0a] border border-white/5 p-4 rounded-lg flex items-center justify-between group hover:border-[#A855F7]/30 transition-all">
    <div className="flex items-center space-x-4">
      <div className={`p-2 rounded bg-white/5 border border-white/5 group-hover:border-[#A855F7]/20 transition-colors`}>
        <Icon className={`h-4 w-4 ${enabled ? 'text-[#A855F7]' : 'text-gray-600'}`} />
      </div>
      <div>
...
const ProtocolCard = ({ title, status, load, icon: Icon }: any) => (
  <div className="bg-[#0a0a0a] border border-white/5 p-4 rounded-lg relative overflow-hidden group">
    <div className="absolute top-0 right-0 p-2 opacity-10 group-hover:opacity-20 transition-opacity">
      <Icon className="h-12 w-12 text-[#A855F7]" />
    </div>
    <div className="relative z-10">
      ...
      <div className="space-y-1">
        ...
        <div className="h-0.5 w-full bg-white/5 rounded-full overflow-hidden">
          <div className="h-full bg-[#A855F7]/50" style={{ width: `${load}%` }} />
        </div>
      </div>
    </div>
  </div>
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 border-b border-white/10 pb-8">
        <div>
          <div className="flex items-center space-x-2 mb-2">
            ...
            <span className="text-[10px] font-mono text-[#A855F7] uppercase tracking-[0.2em]">Root Access // Control Center</span>
          </div>
          <h1 className="text-4xl font-bold text-white tracking-tighter uppercase italic">System <span className="text-[#A855F7]">Controls</span></h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2 space-y-6">
          <div className="bg-[#0a0a0a] border border-white/10 rounded-lg overflow-hidden">
            <div className="p-4 bg-white/[0.02] border-b border-white/10 flex justify-between items-center">
              <div className="flex items-center space-x-2">
                ...
                <h3 className="text-xs font-mono uppercase tracking-widest text-white">Feature Matrix // Enable All Fujers</h3>
              </div>
              <div className="flex items-center space-x-2">
            ...
            <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <MatrixToggle
                label="Repair Matrix"
                description="Ticket management & technician routing"
                icon={Settings}
                enabled={features.repairs}
                onToggle={() => toggleFeature('repairs')}
              />
              <MatrixToggle
          ...
          <div className="bg-[#0a0a0a] border border-white/10 rounded-lg overflow-hidden">
            <div className="p-4 bg-white/[0.02] border-b border-white/10 flex justify-between items-center">
              <div className="flex items-center space-x-2">
                <Server className="h-4 w-4 text-[#A855F7]" />
                <h3 className="text-xs font-mono uppercase tracking-widest text-white">System Event Logs</h3>
              </div>
              <button className="text-[9px] font-mono text-[#A855F7] hover:text-white uppercase tracking-widest">Clear Buffer</button>
            </div>
            <div className="p-4 font-mono text-[10px] space-y-2 max-h-[200px] overflow-y-auto">
              <p className="text-gray-500"><span className="text-[#A855F7]">[03:14:22]</span> AUTH_PROTOCOL_INIT: Identity Vault synchronized successfully.</p>
              <p className="text-gray-500"><span className="text-[#A855F7]">[03:14:25]</span> INVENTORY_SYNC: Fleet Unit PS5-001 reported 98% health.</p>
              <p className="text-emerald-500/70"><span className="text-[#A855F7]">[03:15:01]</span> SYSTEM_STATUS: All nodes reporting optimal performance.</p>
              <p className="text-gray-500"><span className="text-[#A855F7]">[03:15:12]</span> RENTAL_ENGINE: New booking request received for Asset #NSW-112.</p>
              <p className="text-amber-500/70"><span className="text-[#A855F7]">[03:15:45]</span> MAINTENANCE_DAEMON: Unit XBS-042 requires hardware inspection.</p>
              <p className="text-gray-500"><span className="text-[#A855F7]">[03:16:02]</span> PAYMENT_GATEWAY: Transaction #TXN-9928 processed successfully.</p>
            </div>
          </div>
        </div>
          ...
          <div className="bg-[#0a0a0a] border border-white/10 rounded-lg p-6">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between p-3 bg-white/[0.02] border border-white/5 rounded">
                ...
                <span className="text-[10px] font-mono text-[#A855F7] uppercase">Active</span>
              </div>
            </div>
            <button className="w-full mt-6 py-2 bg-[#A855F7] text-black font-bold rounded text-[10px] font-mono uppercase tracking-widest hover:bg-[#9333EA] transition-all">
              Run Global Security Audit
            </button>
          </div>

          {/* Quick Actions */}
          <div className="bg-gradient-to-br from-[#A855F7]/10 to-transparent border border-[#A855F7]/20 rounded-lg p-6">
