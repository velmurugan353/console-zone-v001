...
class InvoiceService {
  generatePDF(data: InvoiceData) {
    ...
    doc.setProperties({
      ...
      subject: 'Invoice from GameVault',
      author: 'GameVault Admin',
      keywords: 'invoice, gamevault, gaming',
      creator: 'GameVault Invoice Generator'
    });
    ...
    doc.setFont('helvetica', 'normal');
    doc.text('GameVault Pvt Ltd', 140, 76);
    ...
    doc.text('Thank you for choosing GameVault - Your Gaming Universe!', 105, 280, { align: 'center' });
